  ...
  return (
    <>
      ...
      {isModalOpen && (
        ...
        >
          <div
            className="relative glass-panel rounded-2xl p-8 max-w-sidebar w-[90%] animate-slide-up shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)]"
                ...
                <div className="relative group">
                  <button
                    ...
                    className={`p-1.5 rounded-md transition-all duration-150 cursor-pointer ${
                      copiedEmail ? 'bg-success/20 text-success' : 'bg-transparent text-text-muted hover:bg-bg-hover hover:text-text-primary'
                    }`}
                  >
              ...
              <div className="flex items-center gap-3 px-4 py-3 bg-bg-primary border border-border rounded-lg">
                ...
                <div className="relative group">
                  <button
                    ...
                    className={`p-1.5 rounded-md transition-all duration-150 cursor-pointer ${
                      copiedLinkedin ? 'bg-success/20 text-success' : 'bg-transparent text-text-muted hover:bg-bg-hover hover:text-text-primary'
                    }`}
                  >
