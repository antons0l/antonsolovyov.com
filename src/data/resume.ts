...
export const resumeData: ResumeData = {
  ...
  experience: [
    ...
    },
    {
      ...
      startDate: "Feb 2022",
      endDate: "Jan 2023",
      description: "Worked with the CTO to build the MVP. Implemented data scraping with OpenSea, 0x, and Rarible APIs for the NFT marketplace. Expanded the customer base by integrating MetaMask wallet sign-in. Built a Discord bot to collect and analyze user statistics.",
